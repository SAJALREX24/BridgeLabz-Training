...
namespace AddressBookWeb.API.Controllers
{
    ...
    public class AddressBookController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<AddressBookEntry>> Create([FromBody] AddressBookEntry entry)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] AddressBookEntry entry)
        {
            if (id != entry.Id)
            {
